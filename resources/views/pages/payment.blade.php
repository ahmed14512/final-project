    ...
    <div class="container">
        <div class="checkout-layout">
                    ...
                    <div class="payment-options">
                        ...
                        <label class="payment-option">
                            <input type="radio" name="payment_method"
                                   value="mastercard">
                            <div class="payment-option-body">
                                <img src="{{ asset('images/icons/master.svg') }}"
                        ...
                        <label class="payment-option">
                            <input type="radio" name="payment_method"
                                   value="applepay">
                            <div class="payment-option-body">
                                <img src="{{ asset('images/icons/applepay.svg') }}"
                                     alt="Apple Pay" class="payment-logo">
                                <span>Apple Pay</span>
                            </div>
                        </label>
                        ...
                        <label class="payment-option">
                            <input type="radio" name="payment_method"
                                   value="googlepay">
                            <div class="payment-option-body">
                                <img src="{{ asset('images/icons/gpay.svg') }}"
                                     alt="Google Pay" class="payment-logo">
                        ...
                        <label class="payment-option">
                            <input type="radio" name="payment_method"
                                   value="cod">
                            <div class="payment-option-body">
                                <img src="{{ asset('images/icons/cod.svg') }}"
                                     alt="Cash" class="payment-logo">
            ...
            <div class="checkout-btn-row">
                    <a href="/checkout" class="checkout-back-btn">
                        <img src="{{ asset('images/icons/arrow-left.svg') }}"
                             alt="back" class="checkout-next-icon">
                        Back
                    </a>
                    <a href="/order-success" class="checkout-next-btn">
                        Complete
                        <img src="{{ asset('images/icons/arrow-right.svg') }}"
                             alt="next" class="checkout-next-icon">
                    </a>
                </div>
        </div>
    </div>
